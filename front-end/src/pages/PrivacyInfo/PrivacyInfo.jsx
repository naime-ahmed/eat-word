...
const PrivacyInfo = () => {
  ...
  return (
    <div className={styles.PPContainer}>
      <Header />
      <main className={styles.PPTextContainer}>
        <h1>Privacy Policy</h1>
        <p className={styles.intro}>
          At Eat Word, we are committed to protecting your privacy. This Privacy
        ...
        <p>
          When you sign up for Eat Word, we collect personal information such as
          your name, email address, and other details necessary for creating and
        ...
        <p>
          Eat Word uses AI tools to help users automatically generate word
        ...
        <p>
          Eat Word may use cookies to improve your experience on our platform.
