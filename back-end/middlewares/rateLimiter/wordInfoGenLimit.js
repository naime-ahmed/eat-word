...
const createLimiter = (points, memoryBlock) => new RateLimiterMongo({
...
const limiters = {
  regular: createLimiter(30, 31),
  pro: createLimiter(3000, 3001)
};
  ...
  try {
    ...
    try {
      ...
      return res.status(429).json({
        ...
        message: `Daily word info generation limit exceeded for ${subscriptionType} plan. Retry after ${Math.ceil((retrySec / 60) / 60)} hours`,
